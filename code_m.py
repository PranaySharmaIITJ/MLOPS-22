...
print(" ")
print('Image Size = '+str(user_size)+'x'+str(user_size))
...
best_val=0
best_test=0
table = [['Gamma','C','Training-Accuracy','Dev','Test']]
for GAM in GAMMA:
	for c in C:
...
print(" ")
print('Good Hyperparameters (Gamma and C) => '+str(best_gam)+' and '+str(best_c))
print('Train, Dev and Test-Accuracy => '+str(best_train)+'%, '+str(best_val)+'%, '+str(best_test)+'%')
print(" ")
###############################################################################
