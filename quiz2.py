...
best_val=0
best_test=0
table = [['Gamma','C','Training Acc.','Dev Acc.','Test Acc.','Min Acc.','Max Acc.','Median Acc.','Mean Acc.']]
for GAM in GAMMA:
	for c in C:
...
print('Train,Dev and Test => '+str(best_train)+'%, '+str(best_val)+'%, '+str(best_test)+'%')
print(" ")
